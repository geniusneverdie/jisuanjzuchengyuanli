...
#拨码�?关连接，用于输入，依次为sw0,sw1,sw7
set_property PACKAGE_PIN AC23 [get_ports wen[0]]
set_property PACKAGE_PIN AC21 [get_ports wen[1]]
set_property PACKAGE_PIN AB6 [get_ports wen[2]]
set_property PACKAGE_PIN W6 [get_ports wen[3]]
set_property PACKAGE_PIN AA7 [get_ports ren[0]]
set_property PACKAGE_PIN Y6 [get_ports ren[1]]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ren_IBUF[0]]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ren_IBUF[1]]
